...
urlpatterns = [
    ...
    path("login/", views.LegacyLoginRedirectView.as_view(), name="login"),
    path("login/citizen/", views.CitizenLoginView.as_view(), name="citizen-login"),
    path("login/official/", views.OfficialLoginView.as_view(), name="official-login"),
