            ...
            <div className="home-inner">
              ...
              <section className="hm-works hm-reveal">
                ...
                <div className="hm-steps">
                    ...
                    <div className="hm-step-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg>
                    </div>
                  ...
                  <div className="hm-step">
                    <div className="hm-step-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="13 18 19 12 13 6"/><polyline points="5 6 11 12 5 18"/></svg>
                    </div>
                    <h3 className="hm-step-title" data-i18n="hiw.step3.title">AI Moderation</h3>
                    <p className="hm-step-desc" data-i18n="hiw.step3.desc">AI scans each report for harmful content before it reaches officials.</p>
                  </div>
                  <div className="hm-step">
                    <div className="hm-step-icon">
                    ...
                    <h3 className="hm-step-title" data-i18n="hiw.step4.title">Official Review</h3>
                    <p className="hm-step-desc" data-i18n="hiw.step4.desc">Your ward office reviews, assigns a team, and posts updates.</p>
                  </div>
                  <div className="hm-step">
                    <div className="hm-step-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
                    </div>
                    <h3 className="hm-step-title" data-i18n="hiw.step5.title">Resolution</h3>
                    <p className="hm-step-desc" data-i18n="hiw.step5.desc">Issue resolved and closed — publicly visible for accountability.</p>
                  </div>
                </div>
              </section>
                ...
                <div className="hm-guide-grid">
                  <div className="hm-guide-step">
                    ...
                    <div className="hm-guide-body">
                      <span className="hm-guide-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg></span>
                  ...
                  <div className="hm-guide-step">
                    ...
                    <div className="hm-guide-body">
                      <span className="hm-guide-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></span>
                  ...
                  <div className="hm-guide-step">
                    ...
                    <div className="hm-guide-body">
                      <span className="hm-guide-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg></span>
                  ...
                  <div className="hm-guide-step">
                    ...
                    <div className="hm-guide-body">
                      <span className="hm-guide-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></span>
              ...
              <section className="hm-cats hm-reveal">
                ...
                <div className="hm-cat-grid">
                  {[
                    { cat: "roads", icon: <i className="fa-solid fa-road"></i>, label: "Road Damage" },
                    { cat: "street_lights", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18h6M12 18v-5a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v5M6 6V4"/><circle cx="18" cy="10" r="3"/><path d="M18 13v1"/></svg>, label: "Street Lights" },
                    { cat: "garbage", icon: <i className="fa-solid fa-trash"></i>, label: "Waste Management" },
                    { cat: "water", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></svg>, label: "Water Supply" },
                    { cat: "traffic", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="12" y1="6" x2="12" y2="6.01"/><circle cx="12" cy="15" r="2"/><path d="M8 22v-2M16 22v-2"/></svg>, label: "Traffic" },
                    { cat: "environment", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>, label: "Environment" },
                    { cat: "health", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>, label: "Public Health" },
                    { cat: "infrastructure", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>, label: "Infrastructure" },
                    { cat: "safety", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, label: "Public Safety" },
                    { cat: "other", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="1"/></svg>, label: "Others" },
                  ].map((c) => (
                    <Link
                      key={c.cat}
