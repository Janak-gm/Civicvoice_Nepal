...
export default function OfficialIssueDetailsPage({
  ...
  return (
    <div className="sv-inner" style={{ maxWidth: 880 }}>
      ...
      <section className="sv-form-section" style={{ borderColor: "#DC2626" }}>
        <h2 style={{ fontFamily: "var(--font-display)", fontSize: 20, fontWeight: 700, margin: "0 0 8px", color: "#DC2626" }}>Danger Zone</h2>
        <p style={{ fontSize: 14, color: "var(--color-muted)", marginBottom: 16 }}>
          Removing this report will permanently delete all its data, images, and videos. The citizen will be notified with the reason.
        </p>
        <button
          onClick={() => router.push(`/official-issue-delete/${report.id}`)}
          style={{
            padding: "12px 28px",
            background: "#DC2626",
            color: "#fff",
