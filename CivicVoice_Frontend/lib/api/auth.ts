...
export async function login(data: LoginData, role?: "citizen" | "official"): Promise<AuthResponse> {
  const endpoint = role === "official" ? "/accounts/login/official/" : "/accounts/login/citizen/"
