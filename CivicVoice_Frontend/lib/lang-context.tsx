...
const translations: Record<string, { en: string; np: string }> = {
  ...
  'hiw.step3.title': { en: 'AI Moderation', np: 'AI निगरानी' },
  'hiw.step3.desc': { en: 'AI scans each report for harmful content before it reaches officials.', np: 'अधिकारीहरूसम्म पुग्नुअघि AI ले हरेक रिपोर्ट जाँच गर्छ।' },
  'hiw.step4.title': { en: 'Official Review', np: 'आधिकारिक समीक्षा' },
  'hiw.step4.desc': { en: 'Your ward office reviews, assigns a team, and posts updates.', np: 'वडा कार्यालयले समीक्षा गरी टोली खटाउँछ र अद्यावधिक गर्छ।' },
  'hiw.step5.title': { en: 'Resolution', np: 'समाधान' },
  'hiw.step5.desc': { en: 'Issue resolved and closed — publicly visible for accountability.', np: 'समस्या समाधान भई बन्द — सार्वजनिक रूपमा देखिने।' },
  ...
  'profile.aiAssistedWriting': { en: 'Enable AI-assisted report writing', np: 'AI-सहायता प्राप्त रिपोर्ट लेखन सक्षम गर्नुहोस्' },
