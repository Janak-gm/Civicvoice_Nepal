...
interface AuthContextType {
  ...
  initialized: boolean
  loading: boolean
  login: (email: string, password: string, role?: "citizen" | "official") => Promise<User>
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const login = useCallback(async (email: string, password: string, role?: "citizen" | "official") => {
    setLoading(true)
    try {
